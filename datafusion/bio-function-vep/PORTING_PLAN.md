...
| Consequence engine | Full transcript/regulatory/motif consequence evaluation | Not yet (phase-1 scaffold) | Full SO term evaluation with rank + impact |
| Consequence term coverage | 41/41 | 0/41 runtime consequence terms | 41/41 (or explicit unsupported list guarded by tests) |
| `most_severe_consequence` | Yes | Placeholder column in `annotate_vep` | Fully computed rank-min consequence |
