    ...
    pub fn output_fields(&self) -> Vec<Field> {
        match self {
            ...
            Self::DbNSFP => vec![
                ...
                Field::new("revel_score", DataType::Float32, true),
                Field::new("gerp_rs", DataType::Float32, true),
                Field::new("phylop100way", DataType::Float32, true),
                Field::new("phylop30way", DataType::Float32, true),
                Field::new("phastcons100way", DataType::Float32, true),
                Field::new("phastcons30way", DataType::Float32, true),
                Field::new("siphy_29way", DataType::Float32, true),
                Field::new("cadd_raw", DataType::Float32, true),
                Field::new("cadd_phred", DataType::Float32, true),
            ],
        }
    }
