...
/// Encode a V5 position key: `[2B chrom_code BE][8B start BE][8B end BE]` = 18 bytes.
///
...
/// Decode a V5 position key back into `(chrom, start, end)`.
...
/// Encode a V5 position key into a reusable buffer (hot-path variant).
///
